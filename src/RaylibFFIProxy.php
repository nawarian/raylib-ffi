 ...
 * @method CData ColorAlphaBlend(CData $dst, CData $src, CData $tint)
 ...
 * @method CData ColorToHSV(CData $color)
 * @method CData ColorFromHSV(float $hue, float $saturation, float $value)
